    ...
    >
      ...
      {isOpen && (
        ...
        >
          ...
          <button type="button" className="w-full flex items-center gap-2.5 px-3 py-2 text-[13px] text-left border-0 bg-transparent font-[inherit] cursor-pointer hover:bg-gray-50 transition-colors" onMouseDown={(e) => e.preventDefault()} onClick={() => { close(); window.dispatchEvent(new CustomEvent('cn-download', { detail: note.id })); }}>
      ...
      <div className="bg-white border border-[#dfe7f1] rounded-lg overflow-hidden">
        ...
        <div className="px-4 py-3 border-t border-[#edf2f7] flex flex-wrap items-center justify-between gap-2">
          <span className="text-[13px] text-[#536173]">
            ...
            <span className="font-medium text-[#374151]">{notes.length}</span> credit notes
          </span>
